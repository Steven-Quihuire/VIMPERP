...
export type InvitationStatusFilter = 'active' | 'expiringSoon' | 'expired';
...
export type InvitationFiltersValue = {
  status: Set<InvitationStatusFilter>;
};
...
export const InvitationFilters = ({
  ...
  value: InvitationFiltersValue;
  onChange: (next: InvitationFiltersValue) => void;
  onClear: () => void;
}) => {
