...
const createGateway = (dependencies: ScopeNodeDependencyCounts) =>
  ({
    getScopeNodeDependencyCounts: vi.fn(() => dependencies),
    countLocalsInDivision: vi.fn(() => 0),
    countAreasInDivision: vi.fn(() => 0),
    countItemsInLocal: vi.fn(() => 0),
    countMembershipsInLocal: vi.fn(() => 0),
    countAreasInLocal: vi.fn(() => 0),
    countWarehousesInLocal: vi.fn(() => 0),
    countPointsOfSaleInLocal: vi.fn(() => 0),
    countWarehousesInArea: vi.fn(() => 0),
    countPointsOfSaleInArea: vi.fn(() => 0),
    countEmployeesInArea: vi.fn(() => 0),
